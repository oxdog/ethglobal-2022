...
export const hardhatNamedAccounts: {
  ...
  deployer: {
    ...
    goerli: '0xA4fFE1Bc6bF4D56509c25AA24930b6b00E3C4567', // it can also specify a specific netwotk name (specified in hardhat.config.js)
    mumbai: '0xA4fFE1Bc6bF4D56509c25AA24930b6b00E3C4567',
  },
  user1: {
    default: 1,
  },
