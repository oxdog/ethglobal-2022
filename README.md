...
- 🔏 Edit your smart contract `Subscription_SuperApp.sol` in `packages/hardhat-ts/contracts`
...
Go through each topic from [solidity by example](https://solidity-by-example.org) editing `Subscription_SuperApp.sol` in **🏗 scaffold-eth**
